...
| [03 Workloads](docs/03-workloads/README.md) | 10-15 | Pods, Deployments, StatefulSets and more | Complete (6/6) |
| [04 Networking](docs/04-networking/README.md) | 16-19, 33 | Networking, Services, Ingress, Network Policies | Complete (5/5) |
...
| [08 Observability](docs/08-observability/README.md) | 30-32 | Monitoring, logging, probes | Complete (3/3) |
...
| [11 Operators](docs/11-operators/README.md) | 32, 37-38 | CRDs and the Operator pattern | In Progress (1/3) |
| [12 Production](docs/12-production/README.md) | 24, 26, 28, 39-42 | Autoscaling, HA, hardening, capacity | In Progress (3/6) |
