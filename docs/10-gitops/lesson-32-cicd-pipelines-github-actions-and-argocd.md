---
title: Lesson 32 - CI/CD Pipelines (GitHub Actions and ArgoCD)
module: 10 GitOps
lesson: 32
status: Complete
...
# Lesson 32 - CI/CD Pipelines (GitHub Actions and ArgoCD)
...
- Understanding of Helm (Lessons 15 and 39) and ArgoCD (Lesson 13).
...
- [Lesson 31 - GitOps Principles and Practices](lesson-31-gitops-principles-and-practices.md) - the GitOps foundation this pipeline builds on.
- [Lesson 24 - Helm Deep Dive (Writing Production Charts)](../09-packaging/lesson-30-helm-deep-dive-writing-production-charts.md) - the Helm chart that CI updates.
- [Lesson 42 - Helm](../09-packaging/lesson-29-helm.md) - Helm fundamentals.
- [Lesson 6 - Jobs and CronJobs](../03-workloads/lesson-10-jobs-and-cronjobs.md) - running recurring pipeline tasks.
