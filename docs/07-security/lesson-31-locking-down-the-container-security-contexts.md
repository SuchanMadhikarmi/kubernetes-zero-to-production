---
title: Lesson 31 - Locking Down the Container (Security Contexts)
module: 07 Security
lesson: 31
status: Complete
...
- Familiarity with how the CRI and the Linux kernel isolate processes (covered in Lesson 07).
...
- [Lesson 27 - RBAC and Service Accounts](lesson-27-rbac-and-service-accounts.md) - authorizing which users and ServiceAccounts may act in the cluster.
- [Lesson 30 - Monitoring and Metrics](../08-observability/lesson-30-monitoring-and-metrics.md) - observing events in the control plane.
- Lesson 29 - Node Pressure and Evictions - security contexts interact with eviction ordering.
