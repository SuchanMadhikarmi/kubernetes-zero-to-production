---
title: Lesson 42 - Node Pressure and Evictions (Saving the Ship)
...
# Lesson 42 - Node Pressure and Evictions (Saving the Ship)
...
- A solid understanding of QoS Classes from [Lesson 21 - Resource Management and the OOMKiller (Requests vs Limits)](../06-configuration/lesson-21-resource-requests-limits-and-quotas.md), including how `request` and `limit` map to Guaranteed, Burstable, and BestEffort.
...
- [Lesson 21 - Resource Management and the OOMKiller (Requests vs Limits)](../06-configuration/lesson-21-resource-requests-limits-and-quotas.md) - how `request` and `limit` map to QoS.
- [Lesson 18 - Cluster Upgrades and Maintenance (Cordon and Drain)](../12-production/lesson-37-cluster-upgrades-and-maintenance.md) - voluntary node eviction with `drain`.
- [Lesson 44 - The SRE Troubleshooting Masterclass](../13-troubleshooting/lesson-41-sre-troubleshooting-masterclass.md) - systematic debugging of node conditions.
