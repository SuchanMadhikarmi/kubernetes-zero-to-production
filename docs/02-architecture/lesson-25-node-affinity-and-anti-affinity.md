---
title: Lesson 25 - Node Affinity and Pod Anti-Affinity
...
- [Lesson 07 - Worker Node Architecture](lesson-07-worker-node-architecture.md) - basic scheduling and taints.
- [Lesson 17 - Pod Priority and Preemption](lesson-17-pod-priority-and-preemption.md) - advanced scheduling concepts.
- [Lesson 24 - Building a 3-Tier Web Application](../12-production/lesson-24-building-a-3-tier-web-application.md) - applying HA to real applications.
