---
title: Lesson 17 - Pod Priority and Preemption
...
- A running kind cluster (ideally the multi-node cluster from Lesson 7).
...
- [Lesson 07 - Worker Node Architecture (Scheduling and Taints)](lesson-07-worker-node-architecture.md) - how the scheduler works.
