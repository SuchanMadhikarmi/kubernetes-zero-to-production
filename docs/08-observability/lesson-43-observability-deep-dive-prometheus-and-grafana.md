---
title: Lesson 43 - Observability Deep Dive (Prometheus and Grafana)
...
# Lesson 43 - Observability Deep Dive (Prometheus and Grafana)
...
| Feature | Metrics Server (Lesson 30) | Prometheus |
|---------|---------------------------|------------|
...
- [Lesson 31 - Logging](lesson-31-logging.md) - the text-log pillar that pairs with metrics.
- [Lesson 33 - Helm](../09-packaging/lesson-33-helm.md) - how the stack is installed.
- [Lesson 26 - Horizontal Pod Autoscaler](../12-production/lesson-26-horizontal-pod-autoscaler.md) - HPA, powered by the Metrics Server, versus Prometheus.

## Coming Next

Lesson 44 continues the observability theme with centralized logging: Loki, LogQL, and how logs complete the metrics pillar for a full troubleshooting toolkit.