---
title: Lesson 28 - Centralized Logging (Loki and Promtail)
...
# Lesson 28 - Centralized Logging (Loki and Promtail)
...
- [Lesson 27 - Observability Deep Dive (Prometheus and Grafana)](lesson-27-observability-deep-dive-prometheus-and-grafana.md) - metrics pillar pairing with logs.
...
- [Lesson 6 - Jobs and CronJobs](../03-workloads/lesson-10-jobs-and-cronjobs.md) - short-lived workloads that lose logs without centralization.

## Coming Next

Lesson 32 continues the observability theme with tracing (Tempo/Jaeger) and how the three pillars of observability work together to correlate a single request end to end.