---
title: Lesson 43 - CKA Exam Masterclass (Speed and Shortcut Techniques)
...
# Lesson 43 - CKA Exam Masterclass (Speed and Shortcut Techniques)
...
- [Lesson 42 - Helm](../09-packaging/lesson-29-helm.md) - imperative vs declarative mindset that carries into exam tasks.
- [Lesson 11 - RBAC and Service Accounts](../07-security/lesson-22-rbac-and-service-accounts.md) - Role and RoleBinding generation patterns.
...
Lesson 44 continues the certification track with the complete CKA Exam Guide: every exam domain mapped to this repository's lessons, plus a timed full-practice-exam strategy.