---
title: Lesson 33 - Extending Kubernetes (CRDs and Operators)
module: 11 Operators
lesson: 33
status: Complete
...
- [Lesson 3 - Controlling Where Pods Run (Scheduling and Taints)](../02-architecture/lesson-03-worker-node-architecture.md) - the API Server and control plane that hosts CRDs.
- [Lesson 11 - RBAC and Service Accounts](../07-security/lesson-22-rbac-and-service-accounts.md) - RBAC is what grants an Operator Pod the permissions it needs.
- [Lesson 23 - Locking Down the Container (Security Contexts)](../07-security/lesson-23-locking-down-the-container-security-contexts.md) - hardening a user's Operator pods.
