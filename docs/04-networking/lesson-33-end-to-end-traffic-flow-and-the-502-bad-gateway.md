---
title: Lesson 33 - End-to-End Traffic Flow and the 502 Bad Gateway
...
- The NGINX Ingress Controller installed (from Lesson 18). If you deleted it, reinstall:
  ```bash
...
- [Lesson 16 - Networking Fundamentals and the CNI](lesson-16-networking-fundamentals-and-the-cni.md) - how Pod networking is created.
- [Lesson 17 - Services and Cluster Networking](lesson-17-services-and-cluster-networking.md) - the Service abstraction and kube-proxy.
- [Lesson 18 - Ingress and Ingress Controllers](lesson-18-ingress-and-ingress-controllers.md) - L7 routing and the NGINX controller.
- [Lesson 19 - Network Policies](lesson-19-network-policies.md) - how to segment traffic across Pods.
