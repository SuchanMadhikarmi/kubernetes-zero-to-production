---
title: Lesson 37 - Service Mesh (Istio and Linkerd)
...
# Lesson 37 - Service Mesh (Istio and Linkerd)
...
- [Lesson 17 - Services and Cluster Networking](lesson-17-services-and-cluster-networking.md) - the Service type the mesh builds on.
- [Lesson 18 - Ingress and Ingress Controllers](lesson-18-ingress-and-ingress-controllers.md) - how traffic enters the mesh via the ingress gateway.
- [Lesson 33 - End-to-End Traffic Flow and the 502 Bad Gateway](lesson-33-end-to-end-traffic-flow-and-the-502-bad-gateway.md) - how mesh proxies alter hop-by-hop routing.
