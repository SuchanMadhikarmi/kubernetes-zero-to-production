---
title: Lesson 14 - Services and Cluster Networking
...
- Completion of Lesson 6 (understanding of Pods, Deployments, and Labels).
...
- **Do not use NodePort for production web apps.** NodePorts bind to high ports (30000+). Users expect traffic on port 80/443. Use an Ingress Controller (Lesson 15) to route port 80 traffic to your Services.
...
- [Lesson 6 - Pods, ReplicaSets, and Deployments](../03-workloads/lesson-06-pods-replicasets-and-deployments.md) - how Pods and Deployments work.
- [Lesson 10 - Ingress and Ingress Controllers](lesson-15-ingress-and-ingress-controllers.md) - routing external HTTP traffic to Services.
