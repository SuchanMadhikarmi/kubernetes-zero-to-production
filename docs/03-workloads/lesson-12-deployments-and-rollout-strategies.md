---
title: Lesson 12 - Deployments and Rollout Strategies
module: 03 Workloads
lesson: 12
status: Complete
...
# Lesson 12 - Deployments and Rollout Strategies
...
- [Lesson 10 - Pods, ReplicaSets, and Deployments](lesson-10-pods-replicasets-and-deployments.md) - how Pods and Deployments work.
- [Lesson 32 - Probes and Health Checks](../08-observability/lesson-32-probes-and-health-checks.md) - Readiness Probes for zero-downtime.
- [Lesson 35 - GitOps Principles and Practices](../10-gitops/lesson-35-gitops-principles-and-practices.md) - Git-based deployments.
