---
title: Lesson 38 - Advanced Stateful Workloads (Databases and Message Queues)
module: 03 Workloads
lesson: 38
status: Complete
...
# Lesson 38 - Advanced Stateful Workloads (Databases and Message Queues)
...
- Familiarity with StatefulSets from Lesson 13 and Helm from Module 09.
...
- [Lesson 13 - StatefulSets](lesson-13-statefulsets.md) - the theory behind this practical lesson.
- [Lesson 20 - Persistent Storage (PV, PVC, SC)](../05-storage/lesson-20-persistent-storage-pv-pvc-sc.md) - how PVCs and StorageClasses back the database disk.
