---
title: Lesson 6 - Pods, ReplicaSets, and Deployments
module: 03 Workloads
lesson: 6
status: Complete
...
# Lesson 6 - Pods, ReplicaSets, and Deployments
...
- [Lesson 8 - StatefulSets](lesson-08-statefulsets.md) - for stateful workloads that need stable identity.
