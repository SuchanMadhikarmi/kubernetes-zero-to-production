---
title: Lesson 10 - Jobs and CronJobs
module: 03 Workloads
lesson: 10
status: Complete
...
- [Lesson 6 - Pods, ReplicaSets, and Deployments](lesson-06-pods-replicasets-and-deployments.md) - for long-running workloads.
- [Lesson 8 - StatefulSets](lesson-08-statefulsets.md) - for stateful workloads.
- [Lesson 9 - DaemonSets](lesson-09-daemonsets.md) - for cluster-wide agents.
