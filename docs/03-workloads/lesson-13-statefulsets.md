...
- [Lesson 10 - Pods, ReplicaSets, and Deployments](lesson-10-pods-replicasets-and-deployments.md) - for stateless workloads.
- [Lesson 14 - DaemonSets](lesson-14-daemonsets.md) - for node-level infrastructure.
- [Lesson 15 - Jobs and CronJobs](lesson-15-jobs-and-cronjobs.md) - for batch workloads.
- [Lesson 20 - Persistent Storage](../05-storage/lesson-20-persistent-storage-pv-pvc-sc.md) - PVs, PVCs, and StorageClasses.
