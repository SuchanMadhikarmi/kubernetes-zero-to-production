...
- A running Kubernetes cluster with multiple nodes (see [Lesson 3](../02-architecture/lesson-03-worker-node-architecture.md) for multi-node kind setup).
...
- [Lesson 6 - Pods, ReplicaSets, and Deployments](lesson-06-pods-replicasets-and-deployments.md) - for user-facing workloads.
- [Lesson 8 - StatefulSets](lesson-08-statefulsets.md) - for stateful workloads.
