---
title: Lesson 19 - Persistent Storage (PVs, PVCs, and StorageClasses)
module: 05 Storage
lesson: 19
status: Complete
...
# Lesson 19 - Persistent Storage (PVs, PVCs, and StorageClasses)
...
- [Lesson 8 - StatefulSets](../03-workloads/lesson-08-statefulsets.md) - for stateful workloads that need stable identity and storage.
