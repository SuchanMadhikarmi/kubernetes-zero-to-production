---
title: Lesson 25 - Resource Management and the OOMKiller (Requests vs Limits)
...
- [Lesson 23 - ConfigMaps and Secrets](lesson-23-configmaps-and-secrets.md) - injecting configuration into Pods.
