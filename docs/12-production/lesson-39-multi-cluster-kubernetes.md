---
title: Lesson 39 - Multi-Cluster Kubernetes
...
# Lesson 39 - Multi-Cluster Kubernetes
...
- [Lesson 33 - Extending Kubernetes (CRDs and Operators)](../11-operators/lesson-33-extending-kubernetes-crds-and-operators.md) - CRDs underpin ApplicationSets and Cluster API.
- [Lesson 12 - Backups and Disaster Recovery with Velero](lesson-38-backups-and-disaster-recovery-with-velero.md) - backups still required in a multi-cluster world.
- [Lesson 35 (GitOps) - GitOps Principles](../10-gitops/lesson-31-gitops-principles-and-practices.md) - the GitOps model that ties clusters together.
