---
title: Lesson 36 - Horizontal Pod Autoscaler
...
# Lesson 36 - Horizontal Pod Autoscaler
...
- The Metrics Server must be installed. If you skipped Lesson 15, install it now:
...
- [Lesson 3 - Controlling Where Pods Run (Scheduling and Taints)](../02-architecture/lesson-03-worker-node-architecture.md) - basic scheduling.
- [Lesson 5 - Node Affinity and Pod Anti-Affinity](../02-architecture/lesson-05-node-affinity-and-anti-affinity.md) - advanced scheduling.
- [Lesson 35 - Building a 3-Tier Web Application](lesson-35-building-a-3-tier-web-application.md) - applying HPA to real applications.
