---
title: Lesson 35 - Backups and Disaster Recovery with Velero
...
- [Lesson 20 - Persistent Storage (PV, PVC, SC)](../05-storage/lesson-20-persistent-storage-pv-pvc-sc.md) - the volumes Velero snapshots.
- [Lesson 28 - Cluster Upgrades and Maintenance (Cordon and Drain)](lesson-28-cluster-upgrades-and-maintenance.md) - planned node maintenance as a trigger for backups.
