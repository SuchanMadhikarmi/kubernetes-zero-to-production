# Lab 19 - Network Policies

## Prerequisite

- Completion of [Lesson 19 - Network Policies](../docs/04-networking/lesson-19-network-policies.md).
...
Proceed to [Lesson 20 - Persistent Storage](../docs/05-storage/lesson-20-persistent-storage-pv-pvc-sc.md) to learn about Volumes, Persistent Volumes, and Storage Classes.
