---
title: Lab 39 - Helm Deep Dive (Writing Production Charts)
lesson: 39
module: 09 Packaging
tags: [kubernetes, helm, charts, templates, values, hooks]
---

# Lab 39 - Helm Deep Dive (Writing Production Charts)
...
- Completion of [Lesson 39 - Helm Deep Dive (Writing Production Charts)](../docs/09-packaging/lesson-39-helm-deep-dive-writing-production-charts.md).
...
Proceed to [Lesson 40](../docs/14-certifications/lesson-40-cka-exam-masterclass.md) to deepen your operational Kubernetes skills, or review [Lesson 33 - Helm](../docs/09-packaging/lesson-33-helm.md) to reinforce the fundamentals.
