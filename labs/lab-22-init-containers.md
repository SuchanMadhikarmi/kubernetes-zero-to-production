...
- Completion of [Lesson 22 - Init Containers](../docs/03-workloads/lesson-22-init-containers.md).
...
Proceed to [Lesson 23 - ConfigMaps and Secrets](../docs/06-configuration/lesson-23-configmaps-and-secrets.md) to learn about injecting configuration into Pods.
