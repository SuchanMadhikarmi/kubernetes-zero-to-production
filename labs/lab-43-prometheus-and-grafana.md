# Lab 43 - Observability Deep Dive (Prometheus and Grafana)

## Prerequisite

- Completion of [Lesson 43 - Observability Deep Dive](../docs/08-observability/lesson-43-observability-deep-dive-prometheus-and-grafana.md).
