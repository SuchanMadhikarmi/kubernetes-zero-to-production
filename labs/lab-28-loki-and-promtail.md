# Lab 28 - Centralized Logging (Loki and Promtail)

## Prerequisite

- Completion of [Lesson 28 - Centralized Logging (Loki and Promtail)](../docs/08-observability/lesson-28-centralized-logging-loki-and-promtail.md).
