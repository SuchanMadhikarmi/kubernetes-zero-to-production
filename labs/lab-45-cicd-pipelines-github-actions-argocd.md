# Lab 45 - CI/CD Pipelines (GitHub Actions and ArgoCD)

## Prerequisite

- Completion of [Lesson 45 - CI/CD Pipelines](../docs/10-gitops/lesson-45-cicd-pipelines-github-actions-and-argocd.md).
...
Create `.github/workflows/deploy.yml` with the workflow from Lesson 45 (build, push to Docker Hub, update `helm/values.yaml` image.tag with `${{ github.sha }}`, commit and push back).
