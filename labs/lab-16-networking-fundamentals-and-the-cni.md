# Lab 16 - Networking Fundamentals and the CNI

## Prerequisite

- Completion of [Lesson 16 - Networking Fundamentals and the CNI](../docs/04-networking/lesson-16-networking-fundamentals-and-the-cni.md).
