...
# Lab 38 - Advanced Stateful Workloads (Databases and Message Queues)
...
- Lesson file: [lesson-38-advanced-stateful-workloads.md](../docs/03-workloads/lesson-38-advanced-stateful-workloads.md)
- Lesson file: [lesson-13-statefulsets.md](../docs/03-workloads/lesson-13-statefulsets.md)
- Lab 13: [lab-13-statefulsets.md](lab-13-statefulsets.md)