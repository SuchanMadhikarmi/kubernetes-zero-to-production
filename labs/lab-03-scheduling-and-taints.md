# Lab 3 - Controlling Where Pods Run (Scheduling and Taints)
...
- Lesson file: [lesson-03-worker-node-architecture.md](../docs/02-architecture/lesson-03-worker-node-architecture.md)
