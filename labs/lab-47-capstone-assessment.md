---
title: Lab 47 - Final Capstone Assessment and Portfolio Project
lesson: 47
...
# Lab 47 - Final Capstone Assessment and Portfolio Project
...
4. Write a `README.md` explaining the architecture (reuse the diagram from Lesson 47), listing the stack: GitHub Actions, ArgoCD, Argo Rollouts, Prometheus, Grafana, Loki, Istio, Cilium.
