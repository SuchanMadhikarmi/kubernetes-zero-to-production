# Lab 19 - Persistent Storage (PVs, PVCs, and StorageClasses)
...
- Lesson file: [lesson-19-persistent-storage-pv-pvc-sc.md](../docs/05-storage/lesson-19-persistent-storage-pv-pvc-sc.md)
