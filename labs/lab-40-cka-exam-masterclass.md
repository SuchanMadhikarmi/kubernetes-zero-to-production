# Lab 40 - CKA Exam Masterclass (Speed and Shortcut Techniques)

## Prerequisite

- Completion of [Lesson 40 - CKA Exam Masterclass](../docs/14-certifications/lesson-40-cka-exam-masterclass.md).
