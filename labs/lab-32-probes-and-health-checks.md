# Lab 32 - Probes and Health Checks

## Prerequisite

- Completion of [Lesson 32 - Probes and Health Checks](../docs/08-observability/lesson-32-probes-and-health-checks.md).
...
Proceed to [Lesson 33 - Helm](../docs/09-packaging/lesson-33-helm.md) to learn about packaging Kubernetes applications with Helm.
