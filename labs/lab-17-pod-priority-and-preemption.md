# Lab 17 - Pod Priority and Preemption

## Prerequisite

- Completion of [Lesson 17 - Pod Priority and Preemption](../docs/02-architecture/lesson-17-pod-priority-and-preemption.md).
...
Proceed to [Lesson 18 - Ingress and Ingress Controllers](../docs/04-networking/lesson-18-ingress-and-ingress-controllers.md) to learn about exposing applications externally.
